...
function DashboardShell({ stats }: { stats: DashboardStats }) {
    ...
    return (
        <div className={`min-h-screen relative font-sans transition-colors overflow-hidden ${currentView === "overview" ? "bg-black" : ""}`}>
            {/* Background - Only show image for country view */}
            ...
            <div className="relative z-10 min-h-screen flex flex-col">
                {/* Top Bar - Only show for country view */}
                {currentView !== "overview" && (
                    <header className="flex flex-col gap-4 mb-8 max-w-[1600px] mx-auto w-full p-4 md:p-8">
